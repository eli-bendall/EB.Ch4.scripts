...
DSF.1.tot <- ggplot(subset(x.stats, veg %in% c("DSF")), aes(x = var))+
  ...
  annotate("text", x = 0.8, y = 68, label = "(b)", size = 5, fontface = 2) +
...
GWD.1.tot <- ggplot(subset(x.stats, veg %in% c("GWD")), aes(x = var))+
  ...
  annotate("text", x = 0.8, y = 68, label = "(c)", size = 5, fontface = 2) +
...
WSF.1.tot <- ggplot(subset(x.stats, veg %in% c("WSF")), aes(x = var))+
  ...
  annotate("text", x = 0.8, y = 68, label = "(a)", size = 5, fontface = 2) +
...
DSF.2.tot <- ggplot(subset(x.stats, veg %in% c("DSF")), aes(x = var)) +
  ...
  annotate("text", x = 0.6, y = 2.5, label = "(b)", size = 5, fontface = 2) +
  
  annotate("text", x = 1.3, y = -12.5, label = "-5.26 %", size = 4, fontface = 2) +
...
GWD.2.tot <- ggplot(subset(x.stats, veg %in% c("GWD")), aes(x = var)) +
  ...
  annotate("text", x = 1.3, y = -12.5, label = "-4.30 %", size = 4, fontface = 2) +
  
  annotate("text", x = 0.6, y = 2.5, label = "(c)", size = 5, fontface = 2) +
...
WSF.2.tot <- ggplot(subset(x.stats, veg %in% c("WSF")), aes(x = var)) +
  ...
  annotate("text", x = 0.6, y = 2.5, label = "(a)", size = 5, fontface = 2) +
  
  annotate("text", x = 1.3, y = -12.5, label = "-16.38 %", size = 4, fontface = 2) +

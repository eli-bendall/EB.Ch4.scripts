...
ligno.species <- ggplot(data = dat.gg) +
...
DSF.1.lg <- ggplot(subset(x.stats, veg %in% c("DSF")), aes(x = var))+
  ...
  annotate("text", x = 0.8, y = 1.75, label = "(b)", size = 5, fontface = 2) +
  
  scale_y_sqrt(breaks = c(0, 0.1, 0.2, 0.4, 0.6, 0.9, 1.2, 1.5, 1.8), labels = ff_num(zero = 0)) +
...
GWD.1.lg <- ggplot(subset(x.stats, veg %in% c("GWD")), aes(x = var))+
  ...
  annotate("text", x = 0.8, y = 1.75, label = "(c)", size = 5, fontface = 2) +
...
WSF.1.lg <- ggplot(subset(x.stats, veg %in% c("WSF")), aes(x = var))+
  ...
  annotate("text", x = 0.8, y = 1.75, label = "(a)", size = 5, fontface = 2) +
...
DSF.2.lg <- ggplot(subset(x.stats, veg %in% c("DSF")), aes(x = var)) +
  ...
  annotate("text", x = 0.525, y = 0.375, label = "(b)", size = 5, fontface = 2) +
  
  annotate("text", x = 1.3, y = -0.45, label = "22.20 %", size = 4, fontface = 2) +
...
GWD.2.lg<- ggplot(subset(x.stats, veg %in% c("GWD")), aes(x = var)) +
  ...
  annotate("text", x = 0.525, y = 0.375,  label = "(c)", size = 5, fontface = 2) +
  
  annotate("text", x = 1.3, y = -0.45, label = "-6.35 %", size = 4, fontface = 2) +
...
WSF.2.lg <- ggplot(subset(x.stats, veg %in% c("WSF")), aes(x = var)) +
  ...
  annotate("text", x = 0.525, y = 0.375,  label = "(a)", size = 5, fontface = 2) +
  
  annotate("text", x = 1.3, y = -0.45, label = "-43.29 %", size = 4, fontface = 2) +

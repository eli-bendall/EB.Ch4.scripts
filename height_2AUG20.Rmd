...
DSF.1.ph <- ggplot(subset(x.stats, veg %in% c("DSF")), aes(x = var))+
  ...
  annotate("text", x = 0.8, y = 115, label = "b", size = 4, fontface = 2) +
...
GWD.1.ph <- ggplot(subset(x.stats, veg %in% c("GWD")), aes(x = var))+
  ...
  annotate("text", x = 0.8, y = 115, label = "c", size = 4, fontface = 2) +
...
WSF.1.ph <- ggplot(subset(x.stats, veg %in% c("WSF")), aes(x = var))+
  ...
  annotate("text", x = 0.8, y = 115, label = "a", size = 4, fontface = 2) +
...
DSF.2.ph <- ggplot(subset(x.stats, veg %in% c("DSF")), aes(x = var)) +
  ...
  annotate("text", x = 0.6, y = 17.5, label = "b", size = 4, fontface = 2) +
  
  annotate("text", x = 1.3, y = -17.5, label = "-4.18 %", size = 3, fontface = 2) +
...
GWD.2.ph <- ggplot(subset(x.stats, veg %in% c("GWD")), aes(x = var)) +
  ...
  annotate("text", x = 0.6, y = 17.5, label = "c", size = 4, fontface = 2) +
  
  annotate("text", x = 1.3, y = -17.5, label = "1.43 %", size = 3, fontface = 2) +
...
WSF.2.ph <- ggplot(subset(x.stats, veg %in% c("WSF")), aes(x = var)) +
  ...
  annotate("text", x = 0.6, y = 17.5, label = "a", size = 4, fontface = 2) +
  
  annotate("text", x = 1.3, y = -17.5, label = "4.56 %", size = 3, fontface = 2) +

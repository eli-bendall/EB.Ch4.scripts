...
CRB.species <- ggplot(data = dat.gg) +
...
DSF.1.ro <- ggplot(subset(x.stats, veg %in% c("DSF")), aes(x = var))+
  ...
  annotate("text", x = 0.8, y = 8, label = "(e)", size = 5, fontface = 2) +
  
  scale_y_sqrt(breaks = c(0, 1, 2, 4, 6, 8.5)) +
...
GWD.1.ro <- ggplot(subset(x.stats, veg %in% c("GWD")), aes(x = var))+
  ...
  annotate("text", x = 0.8, y = 8, label = "(f)", size = 5, fontface = 2) +
...
WSF.1.ro <- ggplot(subset(x.stats, veg %in% c("WSF")), aes(x = var))+
  ...
  annotate("text", x = 0.8, y = 8, label = "(d)", size = 5, fontface = 2) +
...
DSF.2.ro <- ggplot(subset(x.stats, veg %in% c("DSF")), aes(x = var)) +
  ...
  #scale_x_discrete(labels = xtext) +
      ...
      annotate("text", x = 0.525, y = 0.57, label = "(e)", size = 5, fontface = 2) +
  
  annotate("text", x = 1.3, y = -0.7, label = "-4.40 %", size = 4, fontface = 2) +
...
GWD.2.ro <- ggplot(subset(x.stats, veg %in% c("GWD")), aes(x = var)) +
  ...
  geom_hline(yintercept = 0, linetype = "dashed", alpha = 0.5) +
      ...
      annotate("text", x = 0.525, y = 0.57, label = "(f)", size = 5, fontface = 2) +
  
  annotate("text", x = 1.3, y = -0.7, label = "-7.09 %", size = 4, fontface = 2) +
...
WSF.2.ro <- ggplot(subset(x.stats, veg %in% c("WSF")), aes(x = var)) +
  ...
  geom_hline(yintercept = 0, linetype = "dashed", alpha = 0.5) +
      ...
      annotate("text", x = 0.525, y = 0.57, label = "(d)", size = 5, fontface = 2) +
  
   annotate("text", x = 1.3, y = -0.7, label = "-7.82 %", size = 4, fontface = 2) +

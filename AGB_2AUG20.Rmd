...
DSF.1.sh <- ggplot(subset(x.stats, veg %in% c("DSF")), aes(x = var))+
  ...
  annotate("text", x = 0.8, y = 48, label = "e", size = 4, fontface = 2) +
...
GWD.1.sh <- ggplot(subset(x.stats, veg %in% c("GWD")), aes(x = var))+
  ...
  annotate("text", x = 0.8, y = 48, label = "f", size = 4, fontface = 2) +
...
WSF.1.sh <- ggplot(subset(x.stats, veg %in% c("WSF")), aes(x = var))+
  ...
  annotate("text", x = 0.8, y = 48, label = "d", size = 4, fontface = 2) +
...
DSF.2.sh <- ggplot(subset(x.stats, veg %in% c("DSF")), aes(x = var)) +
  ...
  geom_hline(yintercept = 0, linetype = "dashed", alpha = 0.5) +
    ...
    annotate("text", x = 0.6, y = 2.5, label = "e", size = 4, fontface = 2) +
  
  annotate("text", x = 1.3, y = -12.5, label = "-4.96 %", size = 3, fontface = 2) +
...
GWD.2.sh <- ggplot(subset(x.stats, veg %in% c("GWD")), aes(x = var)) +
  ...
  geom_hline(yintercept = 0, linetype = "dashed", alpha = 0.5) +
    ...
    annotate("text", x = 0.6, y = 2.5, label = "f", size = 4, fontface = 2) +
  
  annotate("text", x = 1.3, y = -12.5, label = "-2.14 %", size = 3, fontface = 2) +
...
WSF.2.sh <- ggplot(subset(x.stats, veg %in% c("WSF")), aes(x = var)) +
 ...
 theme(axis.text.y = element_text(size = 10), axis.title.y = element_text(size = 12)) +
  ...
  geom_hline(yintercept = 0, linetype = "dashed", alpha = 0.5) +
    ...
    annotate("text", x = 0.6, y = 2.5, label = "d", size = 4, fontface = 2) +
  
  annotate("text", x = 1.3, y = -12.5, label = "-13.92 %", size = 3, fontface = 2) +
